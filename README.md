...
<!-- LATEST-REPOS:START -->
- [**Uber-fare-prediction-ml**](https://github.com/mightyalok00/Uber-fare-prediction-ml) — End-to-end Uber fare prediction ML project using Python, Scikit-learn, feature engineering, EDA, Gradient Boosting, model evaluation, and Streamlit. (Jupyter Notebook)
